...
- [GLOSSARY.md](GLOSSARY.md): concise TrustDB proof and storage vocabulary.
...
- [docs/integrations/ADR-0014-FISCO-BCOS-ANCHOR-EVIDENCE-PERSISTENCE.md](docs/integrations/ADR-0014-FISCO-BCOS-ANCHOR-EVIDENCE-PERSISTENCE.md): durable block-limit retry journals, immutable native transaction/receipt/block evidence, crash recovery, and logical backup contracts.
...
- [docs/integrations/FISCO_BCOS_OPERATIONS.md](docs/integrations/FISCO_BCOS_OPERATIONS.md): operator runbook for deployment, contract and role governance, key custody, certificate rotation, checkpoint governance, backup and restore, monitoring, incident response, offline verification, and disaster-recovery drills.
