...
| `CRY-06` | `STD-39786`：完整密钥生命周期 | v1 descriptor 已记录 KeyID、suite、算法、provider、公钥、证书链和 provider reference；[`ADR-0009`](ADR-0009-SUITE-AWARE-KEY-REGISTRY-V2.zh-CN.md) 的 Registry V2 已实现不可变 suite manifest、canonical 签名/hash 链、SM2/INTL 注册、幂等导入、原子轮换、时点查询、撤销、compromise、证书有效期约束和崩溃尾帧恢复。SM4 envelope、生产 provider backup/destroy 与真实硬件适配仍待 #451–#453，`Partial` | 审批生成、分发、启用、备份、恢复、销毁 | Security & Cryptography | ADR-0008/0009、密钥台账、事件链、轮换与撤销验证 | `G3` |
