...
本次描述符是运行时边界。持久化和配置中的版本化 software/hardware key descriptor 已由 #449 与 [`ADR-0008`](ADR-0008-VERSIONED-KEY-DESCRIPTORS.zh-CN.md) 实现；逻辑备份不导出 descriptor 所引用的私钥材料或 provider credential。
