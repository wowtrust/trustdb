...
const titles = {
  ...
  "/docs/key-lifecycle": "在线密钥生命周期 · TrustDB 文档",
...
function RouteView({ route }) {
  ...
  if (route === "/docs/key-lifecycle") return <KeyLifecycleDocsPage route={route} />;
...
export function App() {
  ...
  useEffect(() => {
    const onboardingTitles = {
      ...
      "/docs/key-lifecycle": operationsCopy.keyLifecycle.title,
