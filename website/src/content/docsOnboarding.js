...
const zhCN = {
  ...
  quickStart: {
    ...
    keysWarning: "key generate 会替换同名密钥文件。只在新的练习目录执行一次；不要对已经签发过证据的身份重复运行。",
