...
const zhCN = {
  ...
  ui: {
    docs: "文档",
    home: "文档首页",
    updated: "更新于 2026.07.27",
    version: "适用于 TrustDB v2.0.0",
    duration: "预计用时",
    outcome: "完成后你将得到",
    prerequisites: "开始前准备",
    expected: "预期结果",
...
const en = {
  ...
  lang: "en",
  ui: {
    docs: "Docs", home: "Docs home", updated: "Updated 2026-07-27", version: "For TrustDB v2.0.0",
  ...
  index: {
    ...
    meta: "TrustDB onboarding path · v2.0.0", primary: "Start the 10-minute tutorial", secondary: "Understand the evidence model first",
  ...
  quickStart: {
    ...
    downloadTitle: "1. Get v2.0.0", downloadBody: "The website tutorial is pinned to the current stable release. The command downloads the Server/CLI archive and SHA256SUMS for the host architecture and extracts only after verification; do not run this tutorial with a v1 binary.", downloadExpected: "The SHA-256 check passes, the release directory is extracted, and trustdb version reports the current stable release, platform, and architecture.",
