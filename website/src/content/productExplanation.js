      ...
      sections: {
        ...
        paths: {
          ...
          cards: [
            ...
            ["我要审核证据格式", ".sproof v2", "/sproof", "阅读 suite-bound 字段、等级上限、绑定规则和完整验证算法。"],
          ],
        },
      },
    },
