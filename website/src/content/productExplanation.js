  ...
  "zh-CN": {
    home: {
      ...
      capabilities: {
        ...
        benchmarkEyebrow: "Verified benchmark / production-safe",
        metrics: [["23,562", "Submit/s"], ["4,569", "L4/s"], ["2,675,000", "有效提交"], ["0", "报告统计错误"]],
  ...
  en: {
    home: {
      ...
      capabilities: {
        ...
        benchmarkEyebrow: "Verified benchmark / production-safe",
        metrics: [["23,562", "Submit/s"], ["4,569", "L4/s"], ["2,675,000", "valid submissions"], ["0", "reported processing errors"]],
...
content.ru = cloneEnglish("ru", {
  home: {
    ...
    capabilities: {
      ...
      benchmarkEyebrow: "Проверенный тест производительности / готово к эксплуатации",
      metrics: [["23 562", "отправок/с"], ["4 569", "L4/с"], ["2 675 000", "валидных отправок"], ["0", "ошибок обработки в отчёте"]],
...
content.ja = cloneEnglish("ja", {
  home: {
    ...
    capabilities: {
      ...
      benchmarkEyebrow: "検証済み性能試験 / 本番運用対応",
      metrics: [["23,562", "送信/秒"], ["4,569", "L4/秒"], ["2,675,000", "有効な送信"], ["0", "報告上の処理エラー"]],
...
content.fr = cloneEnglish("fr", {
  home: {
    ...
    capabilities: {
      ...
      benchmarkEyebrow: "Mesures vérifiées / prêt pour la production",
      metrics: [["23 562", "soumissions/s"], ["4 569", "L4/s"], ["2 675 000", "soumissions valides"], ["0", "erreur de traitement signalée"]],
...
content.ko = cloneEnglish("ko", {
  home: {
    ...
    capabilities: {
      ...
      benchmarkEyebrow: "검증된 성능 측정 / 운영 환경 대응",
      metrics: [["23,562", "제출/초"], ["4,569", "L4/초"], ["2,675,000", "유효 제출"], ["0", "보고된 처리 오류"]],
