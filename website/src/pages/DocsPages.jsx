...
export function SdkDocsPage({ route }) {
  return (
    <DocsShell route={route}>
      ...
      <section className="doc-section"><h2>安装</h2><p>TrustDB 主分支已迁移到 WowTrust 组织并使用新的 Go module 路径。下一个新路径版本标签发布前，当前源码从 main 安装。</p><CodeBlock>go get github.com/wowtrust/trustdb@main</CodeBlock><Note tone="warn" title="版本状态">v1.0.0-beta.1 发布于迁移前，仍保留旧 module identity。评估项目应固定 go.mod 解析出的 pseudo-version；新路径标签发布后再固定到该标签。</Note></section>
