...
const manualMessages: Messages = {
  en: {
    ...
    '生成身份': 'Create an identity', 'Ed25519 或 SM2，加密保存': 'Encrypted Ed25519 or SM2 signing key',
  ...
  ru: {
    ...
    '生成身份': 'Создать идентификатор', 'Ed25519 或 SM2，加密保存': 'Зашифрованный ключ Ed25519 или SM2',
  ...
  ja: {
    ...
    '生成身份': 'ID を作成', 'Ed25519 或 SM2，加密保存': '暗号化して保存する Ed25519 または SM2 鍵',
  ...
  fr: {
    ...
    '生成身份': 'Créer une identité', 'Ed25519 或 SM2，加密保存': 'Clé Ed25519 ou SM2 conservée chiffrée',
  ...
  ko: {
    ...
    '生成身份': 'ID 만들기', 'Ed25519 或 SM2，加密保存': '암호화하여 저장하는 Ed25519 또는 SM2 키',
